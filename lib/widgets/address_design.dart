...
import 'package:hungerup_users_app/assistantMethods/address_changer.dart';
import 'package:hungerup_users_app/mainScreens/placed_order_screen.dart';
import 'package:hungerup_users_app/maps/maps.dart';
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              ...
              {
                Navigator.
                push(context, MaterialPageRoute(builder: (c) =>
                    PlacedOrderScreen(
